...
{#if userProfile}
  <div class="user-badge-group">
    ...
    <div class="user-dropdown">
      <a href="/profile/account" class=" flex gap-2 px-4 py-2 text-sm hover:bg-blue-700">
       <Icon icon="mdi:account-circle" width="20" height="20" class="text-gray-50" />
        Profil
      </a>
      <button onclick={logout} class=" flex gap-2 w-full px-4 py-2 text-left text-sm hover:bg-blue-700">
