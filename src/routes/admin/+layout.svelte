...
<div class="flex min-h-screen w-full bg-white text-gray-900">
	...
	<aside class="flex w-72 flex-col bg-[#07071a] text-white">
		...
		<nav class="flex-1 overflow-auto px-3 py-6">
			<ul class="space-y-1">
				{#each menu as item}
					<li>
						<a
	...
	<main class="min-h-screen flex-1">
		...
		>
			<div class="flex items-center gap-4">
				...
				<div class="hidden text-sm text-white/70 md:block">Overview</div>
			</div>
				...
				<div class="hidden items-center gap-3 text-sm text-white/80 sm:flex">
					{#if userProfile}
						<div class="user-badge-group">
							<div class="user-info">
								<div
									class="flex h-9 w-9 items-center justify-center rounded-full bg-indigo-600 text-white"
								>
